...
class Monster{
    ...
    drawMonster(){
        ...
        this.head = _mylib__WEBPACK_IMPORTED_MODULE_0__["default"].getRandomFromTo(0, headsIdle.length-1);
        this.body = _mylib__WEBPACK_IMPORTED_MODULE_0__["default"].getRandomFromTo(0, bodiesIdle.length-1);
        this.legs = _mylib__WEBPACK_IMPORTED_MODULE_0__["default"].getRandomFromTo(0, legsIdle.length-1);
